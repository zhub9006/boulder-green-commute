...
| | 🚶 Walking | 🚴 Biking | 🚗 Driving | 🚌 Bus |
|---|---|---|---|---|
| **Distance** | 4.03 km (2.5 mi) | 4.03 km (2.5 mi) | 4.03 km (2.5 mi) | 4.03 km |
| **Time** | ~48 min | ~16 min | ~7–10 min | ~12–15 min |
| **CO₂** | 0 kg | 0 kg | ~0.8 kg/trip | ~0.2 kg |
| **Cost** | Free | Free (own bike) or ~$8 (B-Cycle) | ~$500–$1,250/year | ~$3–5/trip |
...
| **[routes/walking_route.md](routes/walking_route.md)** | Turn-by-turn walking directions with landmarks, cafés, safety & seasonal tips |
...
| **[neighborhood_analysis.md](neighborhood_analysis.md)** | Verified neighborhood profile: restaurants, parks, transit, bike infrastructure |
| **[sustainability_impact.md](sustainability_impact.md)** | Carbon savings, health benefits, financial analysis, Boulder incentives & commitment plan |
...
| **[analysis_summary.md](analysis_summary.md)** | One-click at-a-glance comparison of walking vs biking |
...
2. **Compare Impacts** → See the [commute analysis](commute_analysis.md) side-by-side
3. **Read the sustainability data** → Check out [sustainability_impact.md](sustainability_impact.md)
4. **Use the machine-readable data** → [route_data.json](route_data.json) for your own projects
...
*Data sourced from OpenStreetMap (verified July 2025). Travel times are model estimates at comfortable average speeds (5 km/h walking, 15 km/h biking) and include intersection wait times. Actual times vary with weather, fitness, and traffic.*